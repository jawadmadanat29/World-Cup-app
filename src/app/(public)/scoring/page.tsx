...
const CATEGORY_META: Record<string, { title: string; blurb: string; icon: React.ComponentType<{ className?: string }> }> = {
  ...
  TOURNAMENT: { title: "Tournament specials", blurb: "Surprise team, biggest disappointment, highest-scoring & best defensive teams, and the goals / red-card / hat-trick ranges.", icon: Trophy },
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          ...
          <ul className="ml-4 list-disc space-y-1">
            ...
            <li>Optional extras: first scorer, any-time scorers, assists, both-teams-to-score, clean sheet, and goals/cards ranges.</li>
          </ul>
        </CardContent>
      </Card>
